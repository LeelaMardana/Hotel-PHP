...
const hotelSlider=new Swiper(".hotel-swiper",{loop:!0,navigation:{nextEl:".slider-button--next",prevEl:".slider-button--prev"}}),rewiewsSlider=new Swiper(".reviews-swiper",{loop:!0,navigation:{nextEl:".reviews-btn--next",prevEl:".reviews-btn--prev"}});
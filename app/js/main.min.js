...
const hotelSlider=new Swiper(".hotel-swiper",{loop:!0,navigation:{nextEl:".slider-button--next",prevEl:".slider-button--prev"}}),rewiewsSlider=new Swiper(".reviews-swiper",{loop:!0,navigation:{nextEl:".reviews-btn--next",prevEl:".reviews-btn--prev"}});var menuButton=document.querySelector(".navbar-top__btn");menuButton.addEventListener("click",function(){console.log("Клик по кнопке меню"),document.querySelector(".navbar-menu").classList.toggle("navbar-menu--active")});